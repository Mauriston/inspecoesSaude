---
title: "Resolução CFM nº 2.454/2026 — Uso da Inteligência Artificial na Medicina"
tipo: "Resolução CFM"
numero: "Resolução CFM nº 2.454, de 11 de fevereiro de 2026"
orgao_emissor: "Conselho Federal de Medicina (CFM)"
publicacao_dou: "D.O.U. de 27/02/2026, Edição 39, Seção 1, p. 158; retificação em 05/03/2026, Edição 43, Seção 1, p. 91"
...
status: "vigente (entrada em vigor 180 dias após publicação)"
fonte: "[RES_CFM_2454_2026_NORMATIZA_USO_IA.pdf](https://drive.google.com/file/d/1zEWUzeb1xXTrC15e4jmCoZvSS3QI9uxl/view?usp=drivesdk)"
---
...
- **§ 2°** A auditoria e o monitoramento dos modelos, sistemas e aplicações de IA serão realizados com base em critérios proporcionais ao impacto, garantindo que os modelos, sistemas e aplicações sejam auditáveis ou monitoráveis de forma prática e acessível, respeitando o segredo industrial e comercial.
...
- **§ 4°** As instituições médicas deverão priorizar o desenvolvimento cooperativo de modelos, sistemas e aplicações de IA promovendo a interoperabilidade e a disseminação de tecnologias, códigos, bases de dados e boas práticas com outros órgãos e entidades do setor médico sem prejuízo do sigilo.

**Art. 2°** Para os fins desta resolução, consideram-se as seguintes definições de acordo com o anexo I.

### Capítulo II — Dos Direitos e Deveres dos Médicos na Utilização de IA na Medicina

**Art. 3°** São direitos do médico, na utilização de sistemas de Inteligência Artificial (IA) aplicados à medicina:
...
**Art. 4°** Constituem deveres do médico na utilização de sistemas de Inteligência Artificial na medicina:
...
**Art. 5°** O médico deverá assegurar que o uso de modelos, sistemas e aplicações de inteligência artificial não comprometam a relação médico-paciente, a escuta qualificada, a empatia, a confidencialidade e o respeito à dignidade da pessoa humana.

- **§ 1°** O paciente tem o direito de ser informado, de forma clara e acessível, quando modelos, sistemas e aplicações de IA forem utilizados como apoio relevante em seu cuidado, diagnóstico ou tratamento.
- **§ 2°** É vedado ao médico delegar à IA a comunicação de diagnósticos, prognósticos ou decisões terapêuticas, sem a devida mediação humana.
- **§ 3°** O médico deverá respeitar a autonomia do paciente, inclusive quanto à recusa informada do uso de modelos, sistemas e aplicações de IA.

**Art. 6°** O médico deverá zelar pela confidencialidade, integridade e segurança dos dados de saúde utilizados por modelos, sistemas e aplicações de IA, em conformidade com a legislação vigente.
...
- **§ 2°** O uso de dados pessoais para treinamento, validação ou aprimoramento de modelos, sistemas e aplicações de IA deve observar princípios éticos, científicos e proteção geral de dados pessoais.
- **§ 3°** É vedado ao médico utilizar modelos, sistemas e aplicações de IA que não garantam padrões mínimos de segurança da informação compatíveis com os dados pessoais sensíveis.

**Art. 7°** No campo da responsabilidade ético-profissional, o médico permanece integralmente responsável pelos atos médicos por ele praticados mediante a utilização de modelos, sistemas e aplicações de IA.

- **§ 1°** A utilização da IA não exime o médico do cumprimento do Código de Ética Médica e demais normas emanadas do Conselho Federal de Medicina.
- **§ 2°** É dever do médico comunicar às instâncias competentes eventuais falhas, riscos relevantes ou usos inadequados de modelos, sistemas e aplicações de IA que possam comprometer a segurança do paciente ou a qualidade da assistência.
- **§ 3°** O uso de modelos, sistemas e aplicações de IA aplicados à medicina com finalidade mercantil, publicitária ou promocional deve observar rigorosamente as normas éticas relativas à publicidade médica.

**Art. 8°** O descumprimento dos deveres previstos nesta resolução sujeita o médico às sanções éticas cabíveis, sem prejuízo das responsabilidades civil e penal aplicáveis.
...
**Art. 9°** No desenvolvimento, na validação, na implantação e no uso de modelos, sistemas e aplicações de inteligência artificial na medicina, deverá ser observada a compatibilidade desses modelos, sistemas e aplicações com os direitos fundamentais e com os princípios éticos e bioéticos aplicáveis.

- **§ 1°** A verificação de compatibilidade com os direitos fundamentais, com a ética médica e com a bioética deverá ocorrer em todas as fases do ciclo de vida dos modelos, sistemas e aplicações de IA – incluindo o design, o desenvolvimento, a fase de testes, a implantação, as atualizações e eventuais retreinamentos dos modelos, sistemas e aplicações.
- **§ 2°** As instituições médicas deverão implementar mecanismos de auditoria especializada e monitoramento contínuos.
...
**Art. 12.** As instituições médicas, públicas ou privadas, que desenvolverem ou utilizarem modelos, sistemas e aplicações de IA deverão realizar uma avaliação preliminar com a finalidade de definir seu grau de risco.

- **Parágrafo único.** A avaliação preliminar basear-se-á na categorização e nos critérios previstos neste capítulo e em eventuais diretrizes complementares, levando em conta fatores como o potencial impacto nos direitos fundamentais e na saúde dos pacientes, a criticidade do contexto de uso, a complexidade e grau de autonomia do modelo, a finalidade pretendida e as finalidades potenciais, o nível de intervenção humana no resultado, e a quantidade e sensibilidade dos dados utilizados.
...
- **Parágrafo único.** Em instituições de saúde que adotarem sistemas próprios de IA é necessária a criação de uma Comissão de IA e Telemedicina sob a coordenação médica e subordinada à diretoria técnica cuja função é assegurar o cumprimento do anexo III e garantir o uso ético do sistema e dos usuários.
...
**Art. 16.** Os dados utilizados no desenvolvimento, treinamento, validação e implementação de modelos, sistemas e aplicações de IA na medicina devem ser tratados observando rigorosamente a proteção geral de dados pessoais, bem como as normativas específicas de segurança da informação em saúde. *(Redação conforme retificação do DOU de 05.03.2026; a redação original publicada em 27.02.2026 referia-se expressamente à "Lei Geral de Proteção de Dados Pessoais (LGPD)")*

**Art. 17.** Os dados, modelos, sistemas e aplicações de IA e ambientes computacionais envolvidos no processo de desenvolvimento e implementação na medicina devem ser protegidos de forma eficaz contra riscos de destruição acidental ou intencional, perda, alteração, acessos não autorizados ou vazamentos.

- **Parágrafo único.** Devem ser implementadas medidas técnicas e administrativas de segurança compatíveis com o estado da arte e com a criticidade dos dados e sistemas, o previsto no anexo III.
...
- **§ 1°** Em nenhum momento os modelos, sistemas e aplicações de IA na medicina poderão restringir ou substituir a autoridade final do médico.
- **§ 2°** A decisão sobre diagnóstico, prognóstico, prescrição, ou qualquer ato médico, caberá sempre ao médico, que pode acolher ou rejeitar as sugestões da IA conforme seu julgamento.

**Art. 19.** A autonomia do médico também implica seu direito de não utilizar ou de desligar modelos, sistemas e aplicações de IA aplicados à medicina que julgar inadequados em dada situação, assumindo a responsabilidade por essa decisão.

- **§ 1°** Nenhum médico será penalizado por optar em não seguir a orientação de uma solução de IA, desde que atue de acordo com os preceitos técnicos e éticos.
- **§ 2°** As instituições não devem impor metas ou políticas que subordinem as condutas dos médicos.
...
**Art. 22.** As dúvidas de interpretação referentes a esta resolução, que venham a ser suscitadas pelos Conselhos Regionais de Medicina, serão dirimidas pelo Conselho Federal de Medicina.
...
> ALEXANDRE DE MENEZES RODRIGUES — Secretário-Geral do CFM
...
### Anexo II — Categorização de Riscos
...
### Anexo III — Mecanismos de Governança
...
> Considerando o uso responsável da inteligência artificial, com ênfase na centralidade da pessoa humana, na proteção dos direitos fundamentais e na promoção de sistemas seguros e confiáveis.
> Considerando o Código de Ética Médica (Res. CFM n° 2.217/2018), que consagra princípios fundamentais da prática médica – como a saúde do ser humano, a não discriminação, o sigilo médico e o respeito à autonomia do paciente – os quais devem ser rigorosamente observados no emprego de novas tecnologias em saúde.
> Considerando os princípios bioéticos da autonomia, beneficência, não maleficência e justiça, que orientam a incorporação ética de inovações tecnológicas, garantindo que a inteligência artificial seja empregada em benefício do paciente, evitando danos e assegurando a equidade no cuidado.
> Considerando a natureza sensível dos dados médicos e o dever legal de proteger a privacidade e a confidencialidade das informações de saúde, conforme a proteção geral de dados pessoais e as normas de sigilo profissional, exigindo medidas robustas de segurança da informação na gestão de sistemas de IA em medicina.
> Considerando a necessidade de inovação responsável na saúde, promovendo a eficiência e a qualidade dos serviços médicos por meio da IA, sem jamais comprometer a segurança do paciente, os direitos humanos ou a integridade da relação médico-paciente.
>
> A concepção, o desenvolvimento, a implantação e o uso de soluções de IA na área médica observarão os seguintes princípios:
>
> **I. Justiça, equidade, inclusão e não discriminação abusiva ou ilícita:** a IA deve ser empregada de forma a promover justiça no acesso e na qualidade do cuidado de saúde, evitando-se que algoritmos criem ou reforcem preconceitos contra indivíduos ou grupos em razão de origem, raça, cor, sexo, orientação sexual, idade, religião, condição socioeconômica, condição de saúde ou qualquer outra característica pessoal protegida. Qualquer forma de discriminação indevida ou contrária às legislações vigentes e à ética médica será coibida;
>
> **II. Transparência, explicabilidade, inteligibilidade, contestabilidade, auditabilidade e confiabilidade das soluções de IA:** os modelos de IA devem ser tão transparentes quanto possível, fornecendo explicações compreensíveis sobre seu funcionamento e decisões, de modo que possam ser escrutinados, questionados e auditados por pessoas autorizadas. Deve-se buscar a confiabilidade e robustez nos sistemas, através de testes exaustivos e validação científica, de forma que os profissionais possam confiar em seus resultados dentro de limites de segurança conhecidos;
>
> **III. Segurança do paciente e segurança da informação:** a aplicação de IA em medicina não deve comprometer a segurança do paciente, devendo ao contrário prevenir erros, eventos adversos e melhorar a qualidade do atendimento. Os sistemas devem incorporar proteções técnicas para garantir integridade, disponibilidade e confidencialidade das informações de saúde (incluindo dados sensíveis, como definidos na proteção geral de dados pessoais), prevenindo acessos não autorizados e vazamentos de dados;
>
> **IV. Eficiência e qualidade na prestação de serviços de saúde**, garantindo sempre a observância dos direitos fundamentais e éticos. A introdução de IA deve visar aprimorar processos clínicos e administrativos, reduzir burocracias desnecessárias, agilizar diagnósticos e tratamentos, e elevar a qualidade global do atendimento médico, sem jamais suprimir os direitos dos pacientes ou os deveres dos profissionais;
>
> **V. Respeito à autonomia do paciente, ao consentimento informado e à relação médico-paciente:** é indispensável que o uso de IA não viole o direito do paciente de ser informado sobre sua saúde e de participar das decisões a respeito de seu tratamento. Os pacientes têm direito a receber explicações compreensíveis sobre como uma solução de IA influenciou uma conduta médica e a consentir, quando aplicável, com intervenções baseadas em IA. A introdução de sistemas automatizados não deve enfraquecer a confiança, a empatia e a comunicação franco-honesta que caracterizam a relação terapêutica;
>
> **VI. Devido processo decisório em saúde, contestabilidade e segunda opinião:** as decisões clínicas apoiadas por IA devem observar procedimentos justos e transparentes. Os profissionais e pacientes terão sempre oportunidade de questionar, revisar ou buscar segunda opinião em face de recomendações geradas por IA garantindo um processo decisório robusto e confiável. Em hipótese alguma uma decisão automatizada em saúde será irreversível sem supervisão humana ou sem possibilidade de recurso;
>
> **VII. Accountability (responsabilização) e reparação de danos:** deve-se assegurar a atribuição de responsabilidades a pessoas naturais ou jurídicas por ações e omissões ligadas ao uso de IA em medicina. Os profissionais de saúde e instituições responderão, nos termos da lei e da ética, por decisões tomadas com auxílio de IA não podendo o uso da tecnologia servir para diluir ou ocultar a responsabilidade profissional. Em caso de dano decorrente de falha de um sistema de IA, deverão ser adotadas medidas para reparação integral do paciente lesado, sem prejuízo de responsabilização dos desenvolvedores ou fornecedores, se for o caso;
>
> **VIII. Precaução, prevenção e mitigação de riscos:** dado o potencial de impactos adversos desconhecidos ou não intencionais, o uso de IA deve se pautar pela precaução. Devem ser continuamente identificados e mitigados os riscos sistêmicos e específicos, adotando medidas preventivas para evitar prejuízos à saúde e efeitos indesejados sobre a população. Havendo incerteza substancial sobre a segurança de uma aplicação de IA, deverá prevalecer a cautela, com testes adicionais ou restrições de uso até que a confiabilidade seja comprovada;
>
> **IX. Proporcionalidade e não maleficência:** as soluções de IA devem empregar métodos proporcionais aos fins legítimos buscados, evitando-se complexidades desnecessárias que possam acarretar riscos adicionais. Em consonância com o princípio hipocrático de "primeiro, não causar dano", todo uso de IA na medicina deve ser orientado a minimizar possíveis malefícios, garantindo que os benefícios esperados superem os riscos envolvidos;
>
> **X. Livre iniciativa, desenvolvimento econômico e concorrência leal no âmbito da saúde digital:** respeitando-se a legislação vigente, esta Resolução busca criar ambiente favorável à inovação responsável em saúde, estimulando tanto iniciativas públicas quanto privadas a desenvolverem soluções de IA úteis, dentro de parâmetros éticos e legais claros. A competição saudável e a colaboração entre entes públicos, academia e empresas privadas são encorajadas, visando ampliar o acesso a ferramentas de IA de qualidade para todo o sistema de saúde, ao mesmo tempo em que se protege o consumidor/paciente de práticas abusivas;
>
> **XI. Transparência científica e educação:** promove-se o acesso à informação e à educação acerca das tecnologias de IA e suas aplicações em saúde. Os conhecimentos gerados pelo uso dessas soluções – incluindo suas validações clínicas, resultados e limitações identificadas – devem ser compartilhados com a comunidade científica e com os formuladores de políticas, sempre resguardando dados pessoais, de modo a ampliar o conhecimento coletivo e guiar futuras melhorias nas práticas médicas.
>
> JEANCARLO FERNANDES CAVALCANTE — Conselheiro Relator

## Relevância para a DGPM-406

Ainda que não trate especificamente de perícia médica militar, esta Resolução é relevante para eventual uso de ferramentas de apoio (IA) na condução de IS, elaboração de laudos ou triagem de documentação médica pelos MPI/JRS: reforça que o médico perito permanece integralmente responsável pela decisão pericial (Art. 7º), que a IA jamais substitui a autoridade final do médico (Art. 18), e que seu uso deve ser registrado em prontuário (Art. 4º, V).

## Ver também

- [[res-cfm-2314-2022-telemedicina|Resolução CFM nº 2.314/2022 — Telemedicina]]
- [[res-cfm-2430-2025-ato-medico-pericial|Resolução CFM nº 2.430/2025 — Ato Médico Pericial]]
